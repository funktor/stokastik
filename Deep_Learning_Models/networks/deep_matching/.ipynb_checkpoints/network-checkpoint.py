...
class DeepMatchingNetwork:
    ...
    def init_model(self):
        ...
        nlayer = Conv2D(filters=64, kernel_size=(3, 3), activation='relu', padding='same')(merge) #None, 50, 50
        nlayer = Conv2D(filters=64, kernel_size=(3, 3), activation='relu', padding='same')(nlayer)
        nlayer = BatchNormalization()(nlayer)
        nlayer = GlobalAveragePooling2D()(nlayer)
