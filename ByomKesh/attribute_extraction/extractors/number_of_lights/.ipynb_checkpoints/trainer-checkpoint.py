...
from attribute_extraction.extractors.number_of_lights.normalizer import Normalizer
...
print("Reading data...")
df1 = pd.read_csv('data/number_of_lights.csv')
df2 = pd.read_csv('data/number_of_lights2.csv')
