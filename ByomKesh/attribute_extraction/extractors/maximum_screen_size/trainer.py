...
from attribute_extraction.extractors.maximum_screen_size.normalizer import Normalizer
...
attributes = ['maximum_screen_size']
use_seq_to_seq = True

print("Reading data...")
df = pd.read_csv('data/maximum_screen_size.csv')
