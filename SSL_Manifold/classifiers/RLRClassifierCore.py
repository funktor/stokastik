...
class RLRClassifier(BaseClassifier):
    def __init__(self, n_neighbors, kernel, lambda_k, lambda_u, constant_threshold=0.0, learn_threshold=False, 
        ...
        super(RLRClassifier, self).__init__(n_neighbors, kernel, lambda_k, lambda_u, constant_threshold, learn_threshold, 
    ...
    def fit(self, X_in, Y_in):
        ...
        def grad(alpha):
            return -(2.0/l) * (Y_in.T - JK.dot(alpha).T).dot(JK) + alpha.T.dot(K_KLK)
